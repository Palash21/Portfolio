    ...
    <div class="layout-px-spacing">
	  ...
	  <!-- Add modal start -->
		  ...
		  <div class="modal-dialog modal-lg">
			<div class="modal-content">
						  <div class="modal-header">
							  <h4 class="" style ="text-align:left;" align="left">Brand Add</h4>
						  </div>
            <form action="<?php echo site_url('Adminpanel/Brand_manage/Store');?>" method="post" enctype="multipart/form-data">
       ...
       <table class="table table-bordered table-dark">
        ...
        <?php
  				$i=1;
  				foreach($brand_manage as $v) {
  			?>
			<tr>
			  <th scope="row"><?php echo $i++; ?></th>
			  <td><?php echo $v->brand_name; ?></td>
			  <td><img height="30" src="<?php echo base_url('uploads/' .$v->image);?>"/></td>
        <td><a class="green" data-id="<?php echo $v->brand_id; ?>"  href="#"><i style="font-size:18px;" class="fa fa-pencil-square-o" aria-hidden="true"></i> </a><span style="font-size:18px;">|</span><a href="<?php echo site_url('Adminpanel/Brand_manage/Delete/' .$v->brand_id);?>"> <i style="font-size:18px;" class="fa fa-trash-o" aria-hidden="true"></i></a></td>
      </tr>
        	<?php } ?>
				...
				<div class="modal-content">
				<div class="modal-header">
				<h4 class="" style ="text-align:left;" align="left">Brand Edit</h4>
				</div>
				<div class="modal-body">
          <form action="<?php echo site_url('Adminpanel/Brand_manage/Update');?>" method="post" enctype="multipart/form-data">
          ...
          <div class="modal-body">
            <div class="input-group mb-3">
              ...
              <input type="text" class="form-control" name="brand_name_eidt" id="brand_name_eidt" placeholder="Brand Name" required>
            </div>
            <div class="input-group mb-3">
              <input type="file" class="form-control" name="image_edit">
            </div>
          </div>
            <div class="modal-footer">
...
<script>
		...
		$(document).on("click", ".green", function(e)
		{
			...
			var formURL = "<?php echo site_url('Adminpanel/Brand_manage/edit'); ?>";
			$.ajax(
			{
				url : formURL,
				type: "POST",
				...
				success:function(data){
					...
					$('#brand_name_eidt').val(data.brand_name);
					$('.update').text("Update");
				}
			});
