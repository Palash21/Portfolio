		  ...
		  <div class="modal-dialog modal-lg">
			<div class="modal-content">
						  <div class="modal-header">
							<h4 class="" style ="text-align:left;" align="left">Content Manage Add</h4>
						  </div>
						  <form action="<?php echo site_url('Adminpanel/Content_manage/store');?>" method="post" enctype="multipart/form-data">
						  <div class="modal-body">
								...
								<input type="text" class="form-control" name="content_title" id="content_title" placeholder="Content Title" required>
								</div>
								...
								<input type="text" class="form-control" name="content_details" id="content_details" placeholder="Content Details" required>
								</div>
       ...
       <table class="table table-bordered table-dark">
		  ...
		  <?php
			...
			<tr>
			  ...
			  <td><?php echo $v->content_title; ?></td>
			  <td><?php echo $v->content_details; ?></td>
			  <td><img height="30" src="<?php echo base_url('uploads/' .$v->image);?>"/></td>
			  <td><a class="green" data-id="<?php echo $v->content_id; ?>"  href="#"><i style="font-size:18px;" class="fa fa-pencil-square-o" aria-hidden="true"></i> </a><span style="font-size:18px;">|</span><a href="<?php echo site_url('Adminpanel/Content_manage/Delete/' .$v->content_id);?>"> <i style="font-size:18px;" class="fa fa-trash-o" aria-hidden="true"></i></a></td>
			</tr>
			<?php } ?>
			...
			<div class="modal-content">
			<div class="modal-header">
			<h4 class="" style ="text-align:left;" align="left">Content Manage Edit</h4>
			</div>
			<form action="<?php echo site_url('Adminpanel/Content_manage/Update');?>" method="post" enctype="multipart/form-data">
              ...
              <input type="text" class="form-control" name="content_title_edit" id="content_title_edit" placeholder="Content Title" required>
              </div>
              ...
              <input type="text" class="form-control" name="content_details_edit" id="content_details_edit" placeholder="Content Details" required>
              </div>
...
<script>
		...
		$(document).on("click", ".green", function(e)
		{
			...
			var formURL = "<?php echo site_url('Adminpanel/Content_manage/edit'); ?>";
			$.ajax(
			{
				url : formURL,
				type: "POST",
				...
				success:function(data){
					...
					$('#edit_id').val(data.content_id);
					$('#content_title_edit').val(data.content_title);
					$('#content_details_edit').val(data.content_details);
					$('.update').text("Update");
