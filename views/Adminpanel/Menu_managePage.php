		  ...
		  <div class="modal-dialog modal-lg">
			<div class="modal-content">
						  <div class="modal-header">
							<h4 class="" style ="text-align:left;" align="left">Menu Add</h4>
						  </div>
						  <form action="<?php echo site_url('Adminpanel/Menu_manage/store');?>" method="post" enctype="multipart/form-data">
						  <div class="modal-body">
								<div class="input-group mb-3">
								<div class="input-group-prepend">
								<span class="input-group-text" id="basic-addon1"><i class="fa fa-building" aria-hidden="true"></i></span>
								</div>
								<input type="text" class="form-control" name="menu_name" id="menu_name" placeholder="Name" required>
								</div>
						  </div>
       ...
       <table class="table table-bordered table-dark">
		  ...
		  <?php
			...
			<tr>
			  ...
			  <td><a class="green" data-id="<?php echo $v->menu_id; ?>"  href="#"><i style="font-size:18px;" class="fa fa-pencil-square-o" aria-hidden="true"></i> </a><span style="font-size:18px;">|</span><a href="<?php echo site_url('Adminpanel/Menu_manage/Delete/' .$v->menu_id);?>"> <i style="font-size:18px;" class="fa fa-trash-o" aria-hidden="true"></i></a></td>
			</tr>
			<?php } ?>
			...
			<div class="modal-content">
			<div class="modal-header">
			<h4 class="" style ="text-align:left;" align="left">Menu Edit</h4>
			</div>
			<form action="<?php echo site_url('Adminpanel/Menu_manage/Update');?>" method="post" enctype="multipart/form-data">
			<input type="hidden" class="form-control" name="menu_id" id="menu_id_edit" placeholder="Name" required>
        <div class="modal-body">
								<div class="input-group mb-3">
								<div class="input-group-prepend">
								<span class="input-group-text" id="basic-addon1"><i class="fa fa-building" aria-hidden="true"></i></span>
								</div>
								<input type="text" class="form-control" name="menu_name_edit" id="menu_name_edit" placeholder="Name" required>
								</div>
						  </div>
        <div class="modal-footer">
...
<script>
		...
		$(document).on("click", ".green", function(e)
		{
			...
			var formURL = "<?php echo site_url('Adminpanel/Menu_manage/edit'); ?>";
			$.ajax(
			{
				url : formURL,
				type: "POST",
