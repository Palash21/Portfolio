          ...
          <div class="widget-one">
            <div class="widget-content">
              <div class="w-numeric-value">
                ...
                <div class="w-content"> <span class="w-value">3,192</span> <span class="w-numeric-title">Total Orders</span> </div>
              </div>
              <div class="w-chart">
            ...
            <div class="widget-content">
              ...
              <div class="transactions-list">
                <div class="t-item">
                  <div class="t-company-name">
                    <div class="t-icon">
                      <div class="avatar avatar-xl"> <span class="avatar-title rounded-circle">SP</span> </div>
                    </div>
                    <div class="t-name">
                      <h4>Shaun Park</h4>
                      <p class="meta-date">4 Aug 1:00PM</p>
              ...
              <div class="transactions-list">
                <div class="t-item">
                  <div class="t-company-name">
                    <div class="t-icon">
                      <div class="avatar avatar-xl"> <span class="avatar-title rounded-circle">AD</span> </div>
                    </div>
                    <div class="t-name">
                      <h4>Amy Diaz</h4>
                      <p class="meta-date">4 Aug 1:00PM</p>
          ...
          <div class="widget widget-account-invoice-one">
            ...
            <div class="widget-content">
              <div class="invoice-box">
                ...
                <div class="inv-action"> <a href="#" class="btn btn-dark">Summary</a> <a href="#" class="btn btn-danger">Transfer</a> </div>
              </div>
            </div>
          </div>
        </div>
